...
namespace Query_Parameters_Versioning_And_Securing.Controllers
{
    [ApiVersion("1.0")]
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetAllProducts([FromQuery]ProductQueryParameters queryParameters)
        {
            ...
            if (!string.IsNullOrEmpty(queryParameters.Search))
                products = products.Where(p => p.Name.ToLower().Contains(queryParameters.Search) || p.Sku.ToLower().Contains(queryParameters.Search));
            ...
            products = products.Skip(queryParameters.GetSkippedAmount()).Take(queryParameters.Size);
